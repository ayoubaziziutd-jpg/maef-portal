...
import MAFS_LOGO from '../assets/logoData';
  ...
  return (
    <div className="relative h-screen w-screen overflow-hidden flex flex-col justify-end pb-16 px-6">
      <div
        ...
        style={{ backgroundImage: `url(${MAFS_LOGO})`, filter: 'brightness(0.5)' }}
      />
          ...
          <div className="bg-emerald-950 rounded-3xl p-10 w-full max-w-md mx-6 relative shadow-2xl border border-white/10">
            ...
            <div className="flex flex-col gap-4">
              <button
                ...
                className="flex items-center gap-5 bg-white/10 border border-amber-400/40 rounded-2xl p-6 hover:bg-white/20 transition-all hover:scale-[1.02]"
              >
              ...
              <button
                onClick={onSelectMember}
                className="flex items-center gap-5 bg-white/10 border border-white/20 rounded-2xl p-6 hover:bg-white/20 transition-all hover:scale-[1.02]"
              >
